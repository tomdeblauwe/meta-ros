...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/jazzy/lanelet2_routing/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/jazzy/lanelet2_routing"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "dbd7e7453edcca24e6a8face2b3b64f538039d84"
S = "${WORKDIR}/git"
