...
# matches with: https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_collision_monitor/1.3.7-1.tar.gz
...
SRCREV = "6a3d0efda623d861950e780d0a83511f5cdec5b0"
S = "${WORKDIR}/git"

require nav2-repo.inc
S = "${WORKDIR}/git/nav2_collision_monitor"
