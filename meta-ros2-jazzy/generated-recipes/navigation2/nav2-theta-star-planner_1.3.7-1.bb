...
# matches with: https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_theta_star_planner/1.3.7-1.tar.gz
...
SRCREV = "84d0607652a4005670700e0441df6359a68aa4cd"
S = "${WORKDIR}/git"

require nav2-repo.inc
S = "${WORKDIR}/git/nav2_theta_star_planner"
