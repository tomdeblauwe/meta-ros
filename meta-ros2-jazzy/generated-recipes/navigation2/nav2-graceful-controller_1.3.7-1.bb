...
# matches with: https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_graceful_controller/1.3.7-1.tar.gz
...
SRCREV = "e0e1d093456adf1e6b2a7617fbad284209cebebd"
S = "${WORKDIR}/git"

require nav2-repo.inc
S = "${WORKDIR}/git/nav2_graceful_controller"
