...
# matches with: https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_rotation_shim_controller/1.3.7-1.tar.gz
...
SRCREV = "82fec9af55a4657905200a4cb0b3e7fd3f217655"
S = "${WORKDIR}/git"

require nav2-repo.inc
S = "${WORKDIR}/git/nav2_rotation_shim_controller"
